...
For regular use, copy `build/VoiceKeyboard.app` to Applications, open that copy, and turn on **Voice → Settings → General → Launch at login** if desired. Keep one installed copy: macOS permission grants and login items can refer to the specific app bundle you opened.
